   ...
   <div class="resume-card-name"><i class="fa fa-graduation-cap"></i> Education</div>
	...
	<div class="valign-wrapper"><span class="font-weight-700 uppercase">Image Project</span></div>
		...
		<span class="font-weight-400 second-font"><i class="fa fa-home"></i>  Lagos Nigeria</span><br>
                                ...
                                <li class="google-plus"><a href="#"><i class="fa fa-google-plus"></i></a></li>                                     <li class="linkedin"><a href="#"><i class="fa fa-linkedin"></i></a></li>
                                    </ul>
                                </div>
...
<!-- Mirrored from slimhamdi.net/moscow/demos/index-dark.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 07 Aug 2021 03:01:29 GMT -->
</html>